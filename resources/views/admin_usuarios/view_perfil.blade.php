...
<div class="col-lg-12 col-xs-12">
	<div class="box-content card white">
		...
		<div class="card-content">
			<form class="form-horizontal" id="form" onsubmit="return validar(this)" action="{{url('editar_perfil')}}" method="POST">
			@csrf
				<div class="form-group col-lg-6 ">
					<label for="inp-type-2" class="col-sm-3 control-label">Correo</label>
					<div class="col-sm-9">
						<input type="email" class="form-control" value="{{$usuario[0]->correo}}" required name="correo" readonly id="inputName" pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,5}" placeholder="Ingrese el correo institucional">
					</div>
				</div>
				<div class="form-group col-lg-6 ">
					<label for="inp-type-2" class="col-sm-3 control-label">Nombre</label>
					<div class="col-sm-9">
						<input type="text" class="form-control" readonly value="{{$usuario[0]->nombre_user}}" required pattern="[a-zA-Z ]{2,254}" name="nombre" id="nombre" placeholder="Nombre del usuario">
					</div>
				</div>
				<div class="form-group col-lg-6 ">
					<label for="inp-type-2" class="col-sm-3 control-label">Apellido</label>
					<div class="col-sm-9">
						<input type="text" class="form-control" readonly value="{{$usuario[0]->apellido}}" required pattern="[a-zA-Z ]{2,254}" name="apellido" id="apellido" placeholder="Apellido del usuario">
					</div>
				</div>
				<div class="form-group col-lg-6">
				...
				<div class="form-group col-lg-6">
					...
					<div class="col-sm-9">
						<input type="password" required name="pass1" value="{{$usuario[0]->clave}}" class="form-control" id="pass1" placeholder="Clave">
					</div>
				</div>
				
				<div align="center" class="form-group col-lg-6 switch primary margin-bottom-20">
					@if($usuario[0]->estatus==1)
					<input type="checkbox" id="switch-inline" onclick="javascript: return false;" name="estatus" checked><label for="switch-inline"><strong>Estatus Usuario</strong></label>
					@else
					<input type="checkbox" id="switch-inline" onclick="javascript: return false;" name="estatus" checked><label for="switch-inline"><strong>Estatus Usuario</strong></label>
					@endif
				</div>
				<div class="form-group col-lg-6">
					...
					<div class="col-sm-9">
						<input type="password" required name="pass2" value="{{$usuario[0]->clave}}" class="form-control" id="pass2" placeholder="Confirmar Clave">
					</div>
				</div>
