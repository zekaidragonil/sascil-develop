@extends('principal')
@section('view_verificar_solicitud_consultor')
...
<div class="col-lg-12 col-xs-12">
    ...
    <div class="activity-list">
        ...
        <div class="activity-item">
            ...
            <div class="content">
                <div class="text">
                   <h4>Punto de Adjudicación</h4>
                </div>
                <!-- /.date -->
                <div class="date"><a target="_blank" href="{{$value->punto_estatus}}">Ver Documento</a></div>
                <!-- /.text -->
            </div>
            <!-- /.content -->
        </div>
        ...
        <div class="col-lg-12">
            <br><br>
            <a href="{{url('lista_solicitudes_consultor')}}" class="btn btn-warning btn-rounded" style="color: white"><i class="fa fa-arrow-left" style="color: white"></i> Ir atras</a>
        </div>
    </div>
    @endforeach
    </ul>
