                            ...
                            <ul class="list-inline">
                                <li>
                                    <div class="radio success">
                                        <input type="radio" required name="estatus" value="Recibido" id="radio-10"><label for="radio-10">Aceptado</label></div>
                                    <!-- /.radio -->
                                </li>
                                <li>
                                    <div class="radio danger">
                                        <input type="radio" required name="estatus" value="Rechazado" id="radio-11"><label for="radio-11">Rechazada</label></div>
                                    <!-- /.radio -->
                                </li>
                            </ul>
                        </div>
