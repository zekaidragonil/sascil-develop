@extends('principal')
@section('view_solicitudes_procesadas_presupuesto')
<div class="row small-spacing">
    <div class="col-xs-12">
        <div class="box-content">
            ...
            <br>
            <a href="transferencia_presupuestaria" class="btn btn-rounded btn-warning"><i class="fa fa-arrow-left"></i> Ir Atras </a>
        </div>
        <!-- /.box-content -->
    </div>
</div>
