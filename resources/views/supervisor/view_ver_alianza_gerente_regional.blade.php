@extends('principal')
@section('view_ver_alianza_gerente_regional')
<div class="col-lg-12 col-xs-12">
    <div class="box-content">
        ...
        <div class="activity-list">
            ...
            <div class="col-lg-12">
                <br><br>
                <a href="{{url('lista_asignar_alianza_analista')}}" class="btn btn-warning btn-rounded"><i class="fa fa-arrow-left"></i> Ir Atras</a>
            </div>
