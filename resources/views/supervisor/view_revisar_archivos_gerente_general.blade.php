@extends('principal')
@section('view_archivos_gerente_general')
	<div class="col-lg-12 col-xs-12">
		...
		<div class="activity-list">
			...
			<div class="col-lg-12">
				<br><br>
				<a href="{{url('lista_contrataciones_aceptadas')}}" class="btn btn-warning btn-rounded" style="color: white"><i class="fa fa-arrow-left" style="color: white"></i> Ir atras</a>
			</div>
		</div>
		@endforeach
		</ul>
