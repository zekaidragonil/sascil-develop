...
@section('lista_archivos_procura')
	<div class="col-lg-12 col-xs-12">
		...
		<h4 class="box-title">Documentación a verificar de la Solicitud N°: <b>{{$archivos[0]->numero_solicitud}}</b></h4>
		...
		<div class="activity-list">
			...
			<div class="col-lg-12">
				<br><br>
				<a href="{{url('lista_solicitudes_completas_regional')}}" class="btn btn-warning btn-rounded" style="color: white"><i class="fa fa-arrow-left" style="color: white"></i> Ir atras</a>
			</div>
			@endif
			@if (session('id_perfil')==2)
			<div class="col-lg-12">
				<br><br>
				<a href="{{url('lista_solicitudes_completas')}}" class="btn btn-warning btn-rounded" style="color: white"><i class="fa fa-arrow-left" style="color: white"></i> Ir atras</a>
			</div>
			@endif
