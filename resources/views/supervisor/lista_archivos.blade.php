	...
	<div class="col-lg-12">
		<form action="{{url('estatus_solicitud')}}" method="post">
			...
			<div class="form-group col-lg-6">
				...
				<a href="{{url('lista_solicitudes_completas')}}" class="btn btn-warning btn-rounded" style="color:white"><i class="fa fa-arrow-left"></i> Ir Atras</a>
			</div>
		</form>
	</div>
	@endif
