@extends('principal')
@section('view_expediente_consultor_juridico')
    ...
    <div class="activity-list">
        ...
        <div class="activity-item">
            ...
            <div class="content">
                ...
                <div class="date"><a target="_blank" 
                    href="{{$value->espesificaciones_tecnicas}}"
                    >Ver Documento</a></div>
            </div>
            <!-- /.content -->
        </div>
        ...
        <div class="activity-item">
            ...
            <div class="content">
                ...
                <!-- /.date -->
                <div class="date"><a target="_blank" 
                    href="{{$value->certificacion_presupuestaria}}"
                    >Ver Documento</a></div>
                <!-- /.text -->
            </div>
            <!-- /.content -->
        ...
        <div class="col-lg-12">
            <br><br>
            <a href="{{url('view_asignar_solicitud_contrato')}}" class="btn btn-warning btn-rounded" style="color: white"><i class="fa fa-arrow-left" style="color: white"></i> Ir atras</a>
        </div>
    </div>
    @endforeach
    </ul>
